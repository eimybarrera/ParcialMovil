        ...
        <>
          ...
          {dogData.breeds && dogData.breeds.length > 0 ? (
            <View style={styles.infoContainer}>
              ...
              <Text style={styles.text}>{dogData.breeds[0].weight.metric} kg</Text>

              <Text style={styles.label}>Altura:</Text>
              <Text style={styles.text}>{dogData.breeds[0].height.metric} cm</Text>
              ...
              <Text style={styles.text}>
                {dogData.breeds[0].origin ? dogData.breeds[0].origin : "No disponible"}
              </Text>
            </View>
          ) : (
